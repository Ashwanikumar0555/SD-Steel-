    ...
    <>
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          {/* Mobile Trust Badge */}
          <div className="flex items-center gap-1.5 bg-green-50 text-green-800 px-3 py-2 rounded-md border border-green-200 mb-3">
            <Shield className="h-3 w-3 text-green-600" />
            <span className="text-xs font-medium">Trusted Supplier Since 1998</span>
          </div>
        </div>
        ...
        <div className="fixed bottom-6 right-6 w-80 md:w-96 bg-white rounded-lg shadow-xl z-50 flex flex-col overflow-hidden border border-blue-200">
          ...
          <div className="p-3 border-t border-gray-200 bg-white">
            ...
            <div className="mt-2 text-center text-xs text-gray-500">
              <span>Powered by Shri Durga Steel © 2025</span>
            </div>
          </div>
        </div>
      )}
      ...
      <button
        ...
        className="md:hidden fixed top-0 right-0 px-4 h-16 flex items-center z-50"
      >
        <div className={`w-6 flex flex-col gap-1 transition-all duration-300 ${isMobileMenuOpen ? 'transform rotate-180' : ''}`}>
          <span className={`block h-0.5 bg-blue-700 rounded transition-all duration-300 ${isMobileMenuOpen ? 'w-6 transform -rotate-45 translate-y-1.5' : 'w-6'}`}></span>
          <span className={`block h-0.5 bg-blue-700 rounded transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0' : 'w-4 ml-auto'}`}></span>
          <span className={`block h-0.5 bg-blue-700 rounded transition-all duration-300 ${isMobileMenuOpen ? 'w-6 transform rotate-45 -translate-y-1.5' : 'w-5 ml-auto'}`}></span>
        </div>
      </button>
...
//       icon: <Mail className="h-3 w-3 text-blue-600 group-hover:text-white" />,
//       text: "info@shridurgasteel.in",
//       link: "mailto:shridurgasteel@gmail.com",
//       showOnMobile: true
//     },
//     {
//       icon: <Clock className="h-3 w-3 text-blue-600 group-hover:text-white" />,
